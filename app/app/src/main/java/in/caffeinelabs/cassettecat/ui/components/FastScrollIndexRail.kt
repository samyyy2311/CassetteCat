...
fun <T> FastScrollIndexRail(
    ...
    val scrollLetter = items.getOrNull(firstVisibleIndex)?.let { normalizeIndexChar(labelExtractor(it)) }
    ...
    Box(
        ...
        Column(
            ...
            ALL_LETTERS.forEach { char ->
                ...
                val isCurrent = char == activeLetter || (!isDragging && char == scrollLetter)
