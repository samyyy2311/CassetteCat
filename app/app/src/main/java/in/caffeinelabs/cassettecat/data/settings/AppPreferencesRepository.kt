...
// Library screen live state (sort/layout/filter chosen on the Library screen itself)
...
data class AppPreferences(
    ...
    // Library screen live state (raw enum names, parsed by LibraryViewModel)
